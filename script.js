...
let num1 = 200,
    ...
    num1 = 200 * col1.textContent
    num2 = 6 * col1.textContent
    num3 = 150 * col1.textContent
    num4 = 1 * col1.textContent
    num5 = 2 * col1.textContent
    num6 = 1 * col1.textContent
    num7 = 100 * col1.textContent
